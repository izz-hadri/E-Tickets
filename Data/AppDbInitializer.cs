...
namespace eTickets.Data
{
    public class AppDbInitializer
    {
        ...
        private static void DeleteAll(AppDbContext context)
        {
            ...
            foreach (var producer in context.Producers)
            {
            ...
            foreach (var actor_movie in context.Actors_Movies)
            {
                context.Actors_Movies.Remove(actor_movie);
            }
        ...
        private static void SeedActors_Movies(AppDbContext context)
        {
